...
def ml_retrain():
    ...
    try:
        ...
        train_priority_model()  # always refreshes from latest PRIORITY_TRAINING_DATA
        if success:
            return jsonify({'message': f'✅ Models retrained! Spam model used {len(suggestions)} live suggestions, priority model refreshed.'})
